"""ANNOTATION message — text or formula (LaTeX) placed at canvas coordinates."""
...
class AnnotationHandler:
    async def handle(self, ctx: HandlerContext, message: Mapping[str, object]) -> HandlerResult:
        ...
        if not ctx.state_manager.validate_user_action(user_id, MessageType.ANNOTATION):
        ...
        ctx.state_manager.on_activity(user_id, message_type=MessageType.ANNOTATION)
