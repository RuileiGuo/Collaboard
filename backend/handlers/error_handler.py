...
DEFAULT_ERROR_MESSAGES = {
    ...
    ErrorCode.CONNECTION_ALREADY_EXISTS: "Connection ID already in use",
    ...
    ErrorCode.ANNOTATION_DELETE_REQUEST_ACTIVE: "A delete request is already pending for this annotation",
    ErrorCode.ANNOTATION_DELETE_REQUEST_NOT_FOUND: "No matching annotation delete request",
